...
public class DTNCloseRouter extends ActiveRouter {
	...
	public DTNCloseRouter(Settings s) {
		super(s);
	 ...
	 */
	protected DTNCloseRouter(DTNCloseRouter r) {
		super(r);
	...
	private Tuple<Message, Connection> tryMotionDriven() {
		List<Connection> connections = getConnections();
 		...
 		for (Connection con : connections) { 
			...
			DTNCloseRouter othRouter = (DTNCloseRouter)other.getRouter();
			...
			for (Message m : msgCollection) {
				DTNHost tohost = m.getTo();
	 			...
	 			if (p != null) {
	 				...
	 				Connection cmin = getMinVirtualWeight_F(tohost);
	...
	@Override
	public DTNCloseRouter replicate() {
		// TODO Auto-generated method stub
		return new DTNCloseRouter(this);
	}
}
